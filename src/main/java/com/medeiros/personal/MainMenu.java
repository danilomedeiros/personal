...
import com.medeiros.personal.event.PersonalEvent.NotificationsCountUpdatedEvent;
...
public final class MainMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("<strong>Personal</strong>", ContentMode.HTML);
    ...
    private Component buildMenuItems() {
        ...
        for (final ViewItem view : ViewItem.values()) {
            Component menuItemComponent = new ValoMenuItemButton(view);

            if (view == ViewItem.DASHBOARD) {
                notificationsBadge = new Label();
                notificationsBadge.setId(NOTIFICATIONS_BADGE_ID);
                menuItemComponent = buildBadgeWrapper(menuItemComponent,
                        notificationsBadge);
            }
            if (view == ViewItem.RELATORIOS) {
    ...
    public void updateNotificationsCount(final NotificationsCountUpdatedEvent event) {
        int unreadNotificationsCount = 7;
